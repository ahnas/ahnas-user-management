...
export const ACTION_TYPES = {
    ...
    UPDATE_USER_EMAIL: `${STATE_REDUCER_KEY}/UPDATE_USER_EMAIL`,
    UPDATE_USER_EMAIL_REQUEST: `${STATE_REDUCER_KEY}/UPDATE_USER_EMAIL_REQUEST`,
    UPDATE_USER_EMAIL_SUCCESS: `${STATE_REDUCER_KEY}/UPDATE_USER_EMAIL_SUCCESS`,
    UPDATE_USER_EMAIL_FAILURE: `${STATE_REDUCER_KEY}/UPDATE_USER_EMAIL_FAILURE`,
};
...
export const updateUser =  createAction(ACTION_TYPES.UPDATE_USER_EMAIL)